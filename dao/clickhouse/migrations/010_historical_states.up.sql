...
(
    ...
    his_market_cap         Decimal(30, 2) default 0,
    his_circulating_supply Decimal(30, 2) default 0,
    his_trading_volume     Decimal(30, 2) default 0,
    his_staked_ratio       Decimal(4, 2)  default 0,
    his_inflation_rate     Decimal(4, 2)  default 0,
    his_transactions_count UInt64         default 0,
    his_community_pool     Decimal(30, 2) default 0,
